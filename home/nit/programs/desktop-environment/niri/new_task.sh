...
PROYECTO=$(ls -1 "/home/nit/Documents/1. Obsidian Vaults/Tareas/Proyectos/" | sed 's/\.[^.]*$//' | fuzzel -d -p "✨ Proyecto: "); check_cancel "$PROYECTO"
...
echo "$BODY" > "/home/nit/Documents/1. Obsidian Vaults/Tareas/tareas/$TITLE.md"
